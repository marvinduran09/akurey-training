...
import desktopSinopsisStyle from '../../../styles/desktopSinopsis.module.scss'

function DesktopSinopsis() {
  return (
    <div className='container'>
        <div className={desktopSinopsisStyle.sinopsisDektop}>
            <img src="/image-home.svg" className={desktopSinopsisStyle.sinopsisImg} alt="one piece home"/>
            <div className={desktopSinopsisStyle.sinopsisText}>
                <h4>Sinopsis</h4>
